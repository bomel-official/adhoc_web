...
export async function postAddAccess( req: Request, res: Response, next: NextFunction ) {
    ...
    const { telegramUserId } = validated.data;

    const telegramUser = await TelegramUserProjectRepository.create( validated.data );
